...
st.sidebar.info("Dashboardvisualisasi untuk data Bike Share. "
...
st.subheader('Weekday, Workingday, and Holiday Rent')

fig, axes = plt.subplots(nrows=3, ncols=1, figsize=(15,10))

colors1=["tab:red", "tab:pink"]
colors2=["tab:blue", "tab:green"]
colors3=["tab:red", "tab:orange", "tab:pink", "tab:green", "tab:purple", "tab:brown", "tab:grey"]
...
st.subheader('Daily Rent (Sewa Harian)')
...
st.subheader('Monthly Rent (Sewa berdasarkan Bulanan)')
...
st.subheader('Seasonly Rent (Sewa berdasarkan Musim)')
...
st.subheader('Weatherly Rent (Sewa berdasarkan Kondisi Cuaca)')
...
st.caption('Copyright (c) Sinsin Triana Kian Q March 2024')
